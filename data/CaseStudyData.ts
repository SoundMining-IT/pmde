...
export const SteelpoortCaseStudyData: CaseStudyData = {
    heroImage: "/images/RockLand.webp",
    ...
    heroDescription: "The mine's new owners required urgent technical assistance to identify a new mining area to sustain operations. \n\nThrough comprehensive geological mapping, model validation, and pit optimisation, PMDE enabled the client to secure the resources needed to maintain production and safeguard jobs.",
    ...
    operationalConclusion: "PMDE was tasked with validating the existing planning data and identifying a suitable new mining area to ensure uninterupted production.",
    geologyImage: "/images/DirtyTruck.webp",
    geologyTitle: "PMDE's Solution",
    geologySubtitle: "Geological Mapping, Data Review and Pit Optimisation",
    geologyHeading: "PMDE deployed a team of three experienced geologists equipped with advanced tools to complete a detailed geological mapping of the property.",
    ...
    outcomeSubtitle: "As a result of PMDE's expertise, a new mining area was identified and validated for Sustainable Operations.",
    ...
    outcomeRightSectionImage: "/updatedImages/Side-3.webp",
    partnerBannerImage: "/images/Banner.png",
    partnerTitle: "Partner with PMDE for proven mineral expertise",
    partnerDescription: "With a track record of delivering tailored solutions, PMDE provides the technical expertise needed to overcome complex mineral challenges. From resource estimation to operational efficiency, our team ensures accurate data, streamlined processes, and optimised planning.",
...
export const DrillholeCaseStudyData: CaseStudyData = {
    heroImage: "/images/HeroDrillHole.webp",
    ...
    heroDescription: "PMDE deployed experienced geologists to log, sample, and process 5,600m of core, reducing the backlog by 62%. This enabled an accurate resource estimation, improved operational efficiency, and allowed the client to proceed with critical mine planning.",
    ...
    geologyImage: "/images/MiddleDrillhole.webp",
    geologyTitle: "PMDE's Solution",
    geologySubtitle: "Comprehensive Logging, Sampling, and Quality Control",
    geologyHeading: "PMDE stepped in to deliver a streamlined solution, resolving the backlog and positioning the client for improved resource and reserve planning.",
    geologyDescription: "PMDE deployed two experienced geologists equipped with the necessary tools to tackle the project.",
    processItems: [
        {
            id: 'dh-1',
    ...
    outcomeListTitle: "With PMDE’s sound solution, the following results were achieved:",
    outcomeListItems: [
    ...
    outcomeRightSectionImage: "/images/Iron.webp",
    partnerBannerImage: "/images/Banner.png",
    partnerTitle: "Partner with PMDE for proven mineral expertise",
    partnerDescription: "With a track record of delivering tailored solutions, PMDE provides the technical expertise needed to overcome complex mineral challenges. From resource estimation to operational efficiency, our team ensures accurate data, streamlined processes, and optimised planning.",
    partnerCtaText: "Contact us today to learn how we can support your operations."
...
export const VanadiumCaseStudyData: CaseStudyData = {
  ...
  heroDescription: "To advance the project, PMDE provided geological modelling, feasibility studies, financial advisory, and stakeholder engagement. Their support increased the project's value to $1.05 billion and secured long-term operational stability.",
  ...
  geologyImage: "/images/MiddleVanadium.webp",
  geologyTitle: "Solution: Integrated Technical, Social, and Economic Advisory",
  geologySubtitle: "Over several years, PMDE provided comprehensive support, delivering key services that enabled the project's progression",
  geologyHeading: "PMDE's integrated approach addressed every aspect of the project development cycle.",
  geologyDescription: "By maintaining a long-term partnership, PMDE ensured the company had the necessary expertise at every stage, from exploration to execution.",
  processItems: [
        {
            id: 'v-1',
  ...
  outcomeTitle: "Outcome:",
  outcomeSubtitle: "PMDE's strategic and technical support significantly enhanced the project's value and development trajectory.",
  outcomeListTitle: "This resulted in:",
  outcomeListItems: [
...
export const IronOreCaseStudyData: CaseStudyData = {
  ...
  heroDescription: "PMDE conducted operational audits, provided specialist training, and developed an integrated Life of Mine schedule. This improved production efficiency, enhanced ore quality, and fostered better collaboration between planning teams, ensuring long-term operational success.",
  ...
  operationalConclusion: "PMDE needed to address these challenges with a structured approach to improve the client's planning processes and operational efficiency.",
  ...
  geologyHeading: "PMDE provided a comprehensive solution to address the client's planning and coordination challenges.",
  geologyDescription: "",
  processItems: [
        {
            id: 'io-1',
...
export const TunnelCaseStudyData: CaseStudyData = {
  heroImage: "/images/HeroTunnel.webp",
  ...
  heroDescription: "PMDE conducted a geotechnical study, designed a 7km tunnel, and evaluated excavation methods, recommending a Tunnel Boring Machine. This ensured efficient ore transport while preserving the environment and integrating with national infrastructure.",
  clientImage: "/images/", // Assuming no client image path provided
  clientTitle: "About the client",
  ...
  geologyHeading: "PMDE developed a comprehensive solution to meet both environmental and operational requirements.",
  geologyDescription: "",
  processItems: [
        {
            id: 't-1',
  ...
  outcomeTitle: "Outcome:",
  outcomeSubtitle: "PMDE's design ensured environmentally conscious and efficient ore transport.",
  outcomeListTitle: "This resulted in:",
  outcomeListItems: [
...
export const ManganeseCaseStudyData: CaseStudyData = {
  ...
  heroDescription: "To reverse this, PMDE introduced a structured turnaround strategy, realigned workforce accountability, optimised mine planning, and improved reporting frameworks. These changes drove cultural transformation, boosted productivity, and restored financial stability.",
  clientImage: "/images/", // Assuming no client image path provided
  clientTitle: "About the client",
  ...
  geologySubtitle: "Since 2017, PMDE has provided ongoing technical and strategic support",
  geologyHeading: "PMDE implemented a structured approach to stabilize operations and restore profitability.",
  geologyDescription: "",
  processItems: [
        {
            id: 'mn-1',
  ...
  outcomeTitle: "Outcome:",
  outcomeSubtitle: "The implementation of PMDE's strategies delivered substantial improvements in accountability and production efficiency.",
  outcomeListTitle: "This resulted in:",
  outcomeListItems: [
...
export const StabilityCaseStudyData: CaseStudyData = {
  ...
  heroDescription: "PMDE provided immediate technical intervention, restructured leadership and workplace culture, and developed a financial recovery plan. This stabilised production, restored investor confidence, and strengthened the mine's market position as a key Sinta product supplier.",
  clientImage: "/images/", // Assuming no client image path provided
  clientTitle: "About the client",
  ...
  operationalConclusion: "PMDE needed to implement a structured approach to stabilize operations and deliver long-term strategic improvements.",
  ...
  geologyHeading: "PMDE implemented a three-part strategy to address the mine's complex challenges.",
  geologyDescription: "",
  processItems: [
        {
            id: 'st-1',
...
export const TailingsCaseStudyData: CaseStudyData = {
  heroImage: "/images/HeroTailings.webp",
  ...
  heroDescription: "PMDE assessed economic viability, developed an optimised reclamation strategy, and provided Competent Person sign-off for resource and reserve classification. This secured regulatory approvals, strengthened investor confidence, and ensured compliance with JSE and NYSE listing requirements.",
  clientImage: "/images/", // Assuming no client image path provided
  clientTitle: "About the client",
  ...
  geologyImage: "/images/MiddleTailings.webp",
  ...
  geologyHeading: "PMDE developed a comprehensive tailings management strategy with regulatory expertise.",
  geologyDescription: "",
  processItems: [
        {
            id: 'ta-1',
  ...
  outcomeRightSectionImage: "/images/SideTailings.webp",
  partnerBannerImage: "/images/Banner.png",
  partnerTitle: "Partner with PMDE for proven mineral expertise",
  partnerDescription: "With a track record of delivering tailored solutions, PMDE provides the technical expertise needed to overcome complex mineral challenges. From resource estimation to operational efficiency, our team ensures accurate data, streamlined processes, and optimised planning.",
  partnerCtaText: "Contact us today to learn how we can support your operations."
...
export const EIACaseStudyData: CaseStudyData = {
  heroImage: "/images/HeroEIA.webp",
  heroTitle: "Enhancing Drill and Blast Efficiency Through Industry Collaboration",
  heroIntroText: "The Nahana workshop, hosted by PMDE, addressed inefficiencies in drilling and blasting, safety compliance challenges, and knowledge gaps in modern techniques.",
  ...
  clientDescription: "PMDE hosted the Nahana workshop to address industry-wide challenges in drilling and blasting operations. The workshop brought together mining professionals to share knowledge, best practices, and innovative solutions for optimizing blast design and execution.",
  ...
  geologyImage: "/images/MiddleEIA.webp",
  ...
  processItems: [
        {
            id: 'eia-1',
            iconPaths: { active: '/images/selected 27.svg', inactive: '/images/not selected 27.svg' },
  ...
  outcomeRightSectionImage: "/images/SideEIA.webp",
  partnerBannerImage: "/images/Banner.png",
  partnerTitle: "Partner with PMDE for proven mineral expertise",
  partnerDescription: "With a track record of delivering tailored solutions, PMDE provides the technical expertise needed to overcome complex mineral challenges. From resource estimation to operational efficiency, our team ensures accurate data, streamlined processes, and optimised planning.",
  partnerCtaText: "Contact us today to learn how we can support your operations."
...
export const CoalCaseStudyData: CaseStudyData = {
  ...
  heroIntroText: "PMDE's Nahana Fatigue Management workshop addressed fatigue-related safety risks and operational inefficiencies in the mining sector.",
  ...
  clientImage: "/images/", // Assuming no client image path provided
  clientTitle: "About the workshop",
  clientDescription: "PMDE organized the Nahana Fatigue Management workshop to address a critical safety concern in the mining industry. Fatigue-related incidents were contributing to workplace accidents and operational inefficiencies across the sector, requiring a focused educational initiative.",
...
export const PlatinumCaseStudyData: CaseStudyData = {
  ...
  heroDescription: "PMDE supplied pre-vetted contract personnel, streamlining recruitment and optimising labour costs. This ensured operational continuity, reduced hiring expenses, and provided access to skilled experts, meeting the company's workforce demands effectively.",
  clientImage: "/images/", // Assuming no client image path provided
  clientTitle: "About the client",
  ...
  operationalConclusion: "PMDE needed to provide a flexible and cost-effective labour solution that met the client's specialized workforce requirements.",
  ...
  geologyHeading: "PMDE provided comprehensive labour brokering services to address the client's workforce challenges.",
  geologyDescription: "",
  processItems: [
        {
            id: 'pl-1',
  ...
  outcomeTitle: "Outcome:",
  outcomeSubtitle: "Through PMDE's labour brokering services, the client achieved seamless workforce integration to meet their operational needs.",
  outcomeListTitle: "This resulted in:",
  outcomeListItems: [
  ...
  outcomeRightSectionImage: "/images/SidePlatinum.webp",
  partnerBannerImage: "/images/Banner.png",
  partnerTitle: "Partner with PMDE for proven mineral expertise",
  partnerDescription: "With a track record of delivering tailored solutions, PMDE provides the technical expertise needed to overcome complex mineral challenges. From resource estimation to operational efficiency, our team ensures accurate data, streamlined processes, and optimised planning.",
  partnerCtaText: "Contact us today to learn how we can support your operations."
